...
const val YANDEX_DOMAIN =
    "https://api.weather.yandex.ru/"      //спциально оставил, чтобы было быстрее копипастить и переключаться
...
const val KEY_FAB_WEATHER_LIST = "KEY_FAB_WEATHER_LIST"
